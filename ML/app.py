...
final_svm_model = pickle.load(open('models/saved_final_nb_model.pkl', 'rb'))
final_nb_model = pickle.load(open('models/saved_final_rf_model.pkl', 'rb'))
final_rf_model = pickle.load(open('models/saved_final_svm_model.pkl', 'rb'))
